...
public class ElectricalConstants {
	...
	public static final int TALON_MID = 0;
	public static final int TALON_ELEVATOR = 5;
	public static final int TALON_LEFT_ROLLER = 6;
	public static final int TALON_RIGHT_ROLLER = 7;
	public static final int INTAKE_SOL_F = 1;
