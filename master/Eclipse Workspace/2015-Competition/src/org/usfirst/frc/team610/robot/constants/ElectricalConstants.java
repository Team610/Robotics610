...
public class ElectricalConstants {
	...
	public static final double ENCODER_INCHES = 25.582010582;
	...
	public static final double ELEVATOR_BOTTOM = 0.86; // real bottom 0.89 //Middle .60
	public static final double ELEVATOR_ONETOTE = 0.68;
	public static final double ELEVATOR_TOTEPICKUP = 0.82;
	public static final double ElEVATOR_MID = 0.60;
	public static final double ELEVATOR_TOP = 0.14;   //0.121 top
